...
import UserViewSecurity from 'src/views/apps/patient/view/UserViewSecurity'
...
const UserViewRight = ({ tab, invoiceData }) => {
  ...
  const handleChange = (event, value) => {
    ...
    router
      .push({
        pathname: `/apps/patient/view/${value.toLowerCase()}`
      })
    ...
    <TabContext value={activeTab}>
      ...
      >
        ...
        <Tab
          ...
          label={
            <Box sx={{ display: 'flex', alignItems: 'center', '& svg': { mr: 2 } }}>
              <Icon fontSize={20} icon='mdi:drugs' />
              Prescription
            </Box>
          }
        />
      ...
      <Box sx={{ mt: 4 }}>
        {isLoading ? (
          ...
          <>
            ...
            <TabPanel sx={{ p: 0 }} value='prescription'>
              <UserViewSecurity />
            </TabPanel>
