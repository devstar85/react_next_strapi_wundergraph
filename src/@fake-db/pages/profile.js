...
const data = {
  ...
  profile: {
    about: [
      { property: 'Full Name', value: 'Tony High', icon: 'mdi:account-outline' },
      { property: 'Status', value: 'active', icon: 'mdi:check' },
      { property: 'Role', value: 'Founder and President', icon: 'mdi:star-outline' },
    ...
    contacts: [
      ...
      { property: 'Skype', value: 'Tony.High', icon: 'mdi:message-outline' },
      { property: 'Email', value: 'tony.high@onclickhealth.com', icon: 'mdi:email-outline' }
    ],
    teams: [
      { property: 'Nurses', value: '(126 Members)', icon: 'mdi:github', color: 'primary' },
      { property: 'Business Developers', value: '(98 Members)', icon: 'mdi:react', color: 'info' }
    ],
    overview: [
      { property: 'Task completed', value: '13.5k', icon: 'mdi:check' },
      { property: 'Connections', value: '897', icon: 'mdi:account-outline' },
      { property: 'Projects completed', value: '146', icon: 'mdi:view-grid-plus-outline' }
    ],
    connections: [
      {
        isFriend: false,
