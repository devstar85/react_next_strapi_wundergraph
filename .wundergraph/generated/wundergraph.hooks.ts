...
export interface Queries {
	AllPatients?: {
		mockResolve?: (hook: HookRequestWithInput<InjectedAllPatientsInput>) => Promise<AllPatientsResponse>;
		preResolve?: (hook: HookRequestWithInput<InjectedAllPatientsInput>) => Promise<void>;
		mutatingPreResolve?: (hook: HookRequestWithInput<InjectedAllPatientsInput>) => Promise<InjectedAllPatientsInput>;
		postResolve?: (
			hook: HookRequestWithInput<InjectedAllPatientsInput> & HookRequestWithResponse<AllPatientsResponse>
		) => Promise<void>;
		customResolve?: (hook: HookRequestWithInput<InjectedAllPatientsInput>) => Promise<void | AllPatientsResponse>;
		mutatingPostResolve?: (
			hook: HookRequestWithInput<InjectedAllPatientsInput> & HookRequestWithResponse<AllPatientsResponse>
		) => Promise<AllPatientsResponse>;
	};
	Alldrugs?: {
...
export interface Mutations {
	CreatePatient?: {
		mockResolve?: (hook: HookRequestWithInput<InjectedCreatePatientInput>) => Promise<CreatePatientResponse>;
		preResolve?: (hook: HookRequestWithInput<InjectedCreatePatientInput>) => Promise<void>;
		mutatingPreResolve?: (
			hook: HookRequestWithInput<InjectedCreatePatientInput>
		) => Promise<InjectedCreatePatientInput>;
		postResolve?: (
			hook: HookRequestWithInput<InjectedCreatePatientInput> & HookRequestWithResponse<CreatePatientResponse>
		) => Promise<void>;
		customResolve?: (hook: HookRequestWithInput<InjectedCreatePatientInput>) => Promise<void | CreatePatientResponse>;
		mutatingPostResolve?: (
			hook: HookRequestWithInput<InjectedCreatePatientInput> & HookRequestWithResponse<CreatePatientResponse>
	...
	Login?: {
		...
		mutatingPreResolve?: (hook: HookRequestWithInput<InjectedLoginInput>) => Promise<InjectedLoginInput>;
		postResolve?: (
			hook: HookRequestWithInput<InjectedLoginInput> & HookRequestWithResponse<LoginResponse>
		) => Promise<void>;
		customResolve?: (hook: HookRequestWithInput<InjectedLoginInput>) => Promise<void | LoginResponse>;
		mutatingPostResolve?: (
			hook: HookRequestWithInput<InjectedLoginInput> & HookRequestWithResponse<LoginResponse>
