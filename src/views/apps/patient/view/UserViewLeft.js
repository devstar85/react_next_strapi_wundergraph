          ...
          <Card>
            <CardContent sx={{ pt: 15, display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
              ...
              <CustomChip
                skin='light'
                size='small'
                label={clientNames[data.client]}
                color={clientColors[data.client]}
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Box sx={{ mr: 8, display: 'flex', alignItems: 'center' }}>
                  ...
                  <div>
                    ...
                    <Typography variant='body2'>Drug intake</Typography>
                  </div>
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <div>
                    <Typography variant='h6'>868</Typography>
                    <Typography variant='body2'>without missing</Typography>
                  </div>
                </Box>
              </Box>
            </CardContent>
            ...
            <CardContent>
              ...
              <Box sx={{ display: 'flex', mb: 2 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Code: </Typography><Typography sx={{ mr: 2, fontWeight: 900, fontSize: '0.975rem' }}>{data.code}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 2 }}>
                ...
                <Box sx={{ display: 'flex', mb: 2 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Origin:</Typography>
                  <Typography variant='body2' sx={{ textTransform: 'capitalize' }}>
                    {data.origin}
                  </Typography>
                </Box>
                ...
                <Box sx={{ display: 'flex', mb: 2 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Age:</Typography>
                ...
                <Box sx={{ display: 'flex' }}>
                  <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>County:</Typography>
            ...
            <CardContent>
              <Box sx={{ mt: 6, mb: 5 }}>
                <Box sx={{ display: 'flex', mb: 3.5, alignItems: 'center', '& svg': { mr: 2, color: 'grey.300' } }}>
                  ...
                  <Typography variant='body2'>Call on 01/13/20223</Typography>
                </Box>
                <Box
                  sx={{
                    mb: 3.5,
                ...
                >
                  <Icon icon='mdi:circle' fontSize='0.5rem' />
                  <Typography variant='body2'>Return to hospital on the 16th</Typography>
                </Box>
                <Box
                  sx={{
                    display: 'flex',
                ...
                >
                  <Icon icon='mdi:circle' fontSize='0.5rem' />
                  <Typography variant='body2'>Lack of appetit</Typography>
                </Box>
              </Box>
