  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        externalLink: true,
        openInNewTab: true,
        path: 'https://HealthConnectUs.com/support'
      },
      {
        title: 'Documentation',
        icon: 'mdi:file-document-outline',
        externalLink: true,
        openInNewTab: true,
        path: 'https://demos.HealthConnectUs.com/materio-mui-react-nextjs-admin-template/documentation'
      }
    ]
  }
]
