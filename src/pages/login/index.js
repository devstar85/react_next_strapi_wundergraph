...
const LoginPage = () => {
  ...
  return (
    <Box className='content-right' style={{backgroundImage: `linear-gradient(rgba(256, 256, 256, 256.6), rgba(0, 0, 0, 0.6)), url("https://images.pexels.com/photos/339620/pexels-photo-339620.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")`,         backgroundPosition: 'center',
      ...
      <RightWrapper sx={skin === 'bordered' && !hidden ? { borderLeft: `1px solid ${theme.palette.divider}` } : {}}>
        ...
        >
          <BoxWrapper>
            ...
            >
              <img height='40' alt='logo' src={`/images/pages/logo-client.png`}/>
              <svg
                width={35}
                height={29}
                version='1.1'
